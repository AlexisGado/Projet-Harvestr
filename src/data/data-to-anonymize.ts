...
const M2 = {
    ...
    title: "Apple film",
    content: "I want to play in an apple film with paypal"
};

export const dataToAnonymize = [M1, M2];

const data = JSON.stringify(dataToAnonymize);
writeFileSync(join(__dirname, "data-to-anonymize.json"), data);
